...
abstract final class HealthProfilePayloadCodec {
  HealthProfilePayloadCodec._();
  ...
  static void parseAnswer10IntoFormData(
    String raw,
    void Function(String frequency) setFrequency,
    void Function(List<String> types) setTypes,
  ) {
    if (raw.contains('###')) {
      final p = raw.split('###');
      var freq = p[0].trim();
