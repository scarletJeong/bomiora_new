...
abstract final class PolicyTexts {
  PolicyTexts._();

  static const String termsHeading = '보미오라 이용약관';
  static const String privacyHeading = '개인정보취급방침';

  static const List<PolicySection> termsSections = [
    PolicySection(
      '제1조(목적)',
      '이 약관은 (주)보미오라(전자상거래 사업자)가 운영하는 (주)보미오라 사이버 몰(이하 "몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.\n※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다.」',
    ),
    PolicySection(
      '제2조(정의)',
      '① "몰"이란 (주)보미오라 회사가 재화 또는 용역(이하 "재화 등"이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.\n② "이용자"란 "몰"에 접속하여 이 약관에 따라 "몰"이 제공하는 서비스를 받는 회원 및 비회원을 말합니다.\n③ \'회원\'이라 함은 "몰"에 회원등록을 한 자로서, 계속적으로 "몰"이 제공하는 서비스를 이용할 수 있는 자를 말합니다.\n④ \'비회원\'이라 함은 회원에 가입하지 않고 "몰"이 제공하는 서비스를 이용하는 자를 말합니다.',
    ),
    PolicySection(
    ...
    PolicySection(
      ...
      '① "몰"은 이용자의 구매신청이 있는 경우 이용자에게 수신확인통지를 합니다.\n② 수신확인통지를 받은 이용자는 의사표시의 불일치 등이 있는 경우에는 수신확인통지를 받은 후 즉시 구매신청 변경 및 취소를 요청할 수 있고 "몰"은 배송 전에 이용자의 요청이 있는 경우에는 지체 없이 그 요청에 따라 처리하여야 합니다. 다만 이미 대금을 지불한 경우에는 제16조의 청약철회 등에 관한 규정에 따릅니다.',
    ),
    PolicySection(
      '제13조(재화 등의 공급)',
    ...
    PolicySection(
      '제15조(포인트 제도)',
      '① "몰"은 회원에게 재화 등의 구매, 이벤트 참여, 고객 서비스 정책 등에 따라 포인트(이하 "포인트"라 함)를 부여할 수 있습니다.\n② 포인트는 "몰"에서 정한 기준 및 정책에 따라 지급되며, 현금으로 환급되지 않습니다.\n③ 포인트의 유효기간은 지급일로부터 1년이며, 유효기간 내 사용되지 않은 포인트는 자동 소멸됩니다.\n④ 포인트는 "몰"에서 제공하는 재화 또는 용역의 결제 시 일부 또는 전부를 결제수단으로 사용할 수 있으며, 구체적인 사용 방법은 "몰"의 정책에 따릅니다.\n⑤ 회원 탈퇴 시, 미사용한 포인트는 자동 소멸되며, 어떠한 경우에도 현금으로 환급되지 않습니다.\n⑥ "몰"은 사전 고지 후 포인트 정책을 변경하거나 포인트 제도를 종료할 수 있으며, 이 경우 관련 사항은 "몰" 초기화면 또는 공지사항 등을 통해 회원에게 안내합니다.',
    ),
    PolicySection(
      '제16조(청약철회 등)',
  ...
  static const List<String> privacyIntros = [
